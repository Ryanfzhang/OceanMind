...
SYSTEM_PROMPT = (
    ...
    "Treat the requested time, variable, depth, and method as given even when UI "
    "controls show defaults; obtain discoverable dataset details with tools. "
    "Ask only for the one missing choice, briefly stating why it matters. You may suggest a "
