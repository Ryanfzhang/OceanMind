...
SYSTEM_PROMPT = (
    ...
    "If continuing requires an essential user choice, call request_clarification "
    "rather than writing a failure report or ending with a question in plain text. "
    "Use explicit request details over passive UI defaults. The agent may select "
    "data and methods through tools; do not ask the user to change UI controls. "
    "Resolve details available from context or tools before asking for one "
    "indispensable user choice, briefly stating why it matters. You may suggest a "
    ...
    *,
    ...
    if analysis_session is not None:
        ...
        analysis_prompt = (
            ...
            "When all intended results are saved and their quality is established, answer "
