    ...
    *,
    ...
    if analysis_session is not None:
        ...
        analysis_prompt = (
            ...
            "The UI shows both on the main interactive map. Use a static PNG when "
            "a composed view, such as multiple panels or annotations, adds useful detail; "
            ...
            "publish a missing requested figure from saved data. Verify numerical findings before making claims "
            "from an image."
