    ...
    *,
    ...
    if analysis_session is not None:
        ...
        analysis_prompt = (
            ...
            "For geographic results, publish coordinate-bearing data: a 2D "
            "DataArray or lon/lat/values field, and events with lon/lat for "
            "points. The UI shows these on the main interactive map. A PNG is optional "
            "supplementary output and should reference the spatial result in inputs. "
