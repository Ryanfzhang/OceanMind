    ...
    *,
    ...
    if analysis_session is not None:
        ...
        analysis_prompt = (
            ...
            "For a transect flux Hovmoller spanning more than one year, set "
            "include_climatology=True on tools.compute_transect_normal_flux_hovmoller "
            "unless the user asks for only the original timeline. This one tool call "
            "saves both original and climatology views; do not republish them. "
