...
ANSWER_PROMPT = (
    ...
    "use Markdown tables only with one row per line. Cite only URLs returned "
    "by web_search in this conversation; never add a remembered source link. "
    "When usable web results were retrieved, cite at least one supporting URL "
    "inline with the claim it supports. "
    "For a factual or scientific question that does not "
